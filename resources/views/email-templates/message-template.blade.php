                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                    <tr>
                      <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                        <div style="background-color:rgb(21, 24, 41);margin:50px;">
                          <img src="<?php echo $message->embed($pathToImage); ?>" style="height:40px;margin:20px;">
                        </div>
                        <div style="display: flex; justify-content:center; text-align: center; padding-left:50px; padding-right:50px;">
                          <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;"><b>You've received messages from {{ $from_name }}</b></p>
                        </div>

                        <div style="display: flex; margin-top:50px;  padding-left:50px; padding-right:50px;">
                          <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;">Hi  {{ $name }} ,</p>
                        </div>
                        <div style=" padding-left:50px; padding-right:50px;">
                          <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;">messages:</p>
                        </div>

                        <div style="display: flex; justify-content:center; text-align: center; margin-top:50px; padding-left:50px; padding-right:50px;">
                          <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">{{ $content }}</p>
                        </div>

                        <div style="display: flex; margin-top:50px; justify-content:center; text-align: center; padding-left:50px; padding-right:50px;">
                          <button type="button" class="btn">
                            <a style="text-decoration: none; color:white;" href="https://www.futurestarr.com/"><b>View and Replay</b></a>
                          </button>
                        </div>
                <br><br>
