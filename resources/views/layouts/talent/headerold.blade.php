   ...
   <div  class="row">
    <div id="navbar"  class="col-sm-12">
     <ul class="social-media">
      ...
      <li>
       <a href="https://vimeo.com/735545596" target="_blank" data-toggle="tooltip" title="Vimeo">
...
<div class="container-fluid h-font nmbar">
  <div class="navbar-header">
   ...
   <a class="{{$className}}" href="/" title="Future Starr" style="z-index: 9999;">
     <img loading="lazy" decoding="async" class="img-responsive sm-logo" alt="futurestarr logo" src="{{ asset('assets/images/futurelogo.png')}}" >
   </a>
 </div>
    ...
    <li class="{{ Route::currentRouteName() == 'home' ? 'active' : '' }}">
     <a href="{{URL::to('/')}}" title="Entertainment Career, community">
      <div class="header-icon">
       <img loading="lazy" decoding="async" class="fa-icon-font" alt="Futurestarr Home" src="{{ asset('assets/images/home/home.png')}}">
     </div>
     HOME
   </a>
 </li>
                 ...
                 <li class="{{ Route::currentRouteName() == $route  ? 'active' : '' }}">
                   <a href="{{$route}}">
                    <div class="header-icon">
                      <img loading="lazy" decoding="async" class="fa-icon-font" alt="futurestarr dashboard" src="{{ asset('assets/images/home/dashboard.png')}}">@if(!empty($user_chat_message)) <span class="fa-icon-font msg-count-out" style="background: #ff503f;padding: 5px;border-radius: 50%;">
                ...
                <li class="{{ Route::currentRouteName() == 'search.index'  ? 'active' : '' }}">
                 <a href="{{ route('search.index')}}" title="Future Starr, Tattoo Artists">
                  <div class="header-icon">
                    <img loading="lazy" decoding="async" class="fa-icon-font" src="{{ asset('assets/images/home/starr_s.png') }}" alt="starsearch icon">
                  </div>STARR SEARCH
                 </a>
                </li>
                <li class="{{ Route::currentRouteName() == 'talent.index'  ? 'active' : '' }}">
                 <a href="{{ route('talent.index')}}" title="Sign up, Future Starr, model photos, music songs, educational courses, fitness tips">
                  <div class="header-icon"><img loading="lazy" decoding="async" class="fa-icon-font" src="{{ asset('assets/images/home/tallent_m.png') }}" alt="Tallent Mall Icon"></div>TALENT MALL</a>
                </li>
                <li class="{{ Route::currentRouteName() == 'social-buzz.index'  ? 'active' : '' }}">
                 <a href="{{ route('social-buzz.index')}}" >
                  <div class="header-icon">
                    ...
                    <img loading="lazy" decoding="async" class="fa-icon-font" src="{{ asset('assets/images/home/social_b.png') }}" alt="Social buzz icon">
                  </div>SOCIAL BUZZ
                 </a>
                </li>
                <li class="{{ Route::currentRouteName() == 'blog.index'  ? 'active' : '' }} || {{ Route::currentRouteName() == 'blog.detailed'  ? 'active' : '' }}">
                 <a href="{{ route('blog.index')}}" >
                  <div class="header-icon"><img loading="lazy" decoding="async" class="fa-icon-font" src="{{ asset('assets/images/home/blog.png') }}" alt="Blog Icon"></div>BLOG
                 </a>
                </li>          
                <li class="{{ Route::currentRouteName() == 'contact-us.index'  ? 'active' : '' }}">
                 <a href="{{ route('contact-us.index')}}">
                  <div class="header-icon">
                    <img loading="lazy" decoding="async" class="fa-icon-font" src="{{ asset('assets/images/home/contact.png') }}" alt="Contact Us Icon">
                  </div>CONTACT US
                 </a>
                </li>
                ...
                <li>
                  <a href="javascript:void(0)" id="search-toggle">
                    <div class="header-icon">
                      <i class="fa fa-search" aria-hidden="true" style="color: #f7f7f7; padding-top: 4px; font-size: 17px;"></i>
                    </div>Search
                  </a>
                </li>
                @endif
             ...
             <li>
               <a class="dropdown-margin" role="button" data-toggle="dropdown">
                ...
                <div class="header-icon he-ic">
                 ...
                 <img  loading="lazy" decoding="async" class="fa-icon-font" src="{{asset(Auth::user()->profile_pic)}}" alt="star icon" style="border-radius: 50%; height: 23px; padding: 0px 0px 0px 0;object-fit: cover;">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 login-back">
         ...
         <span id="cred_error"></span>
          ...
          <div class="row">
            ...
            <div class="row">
              <div  class="col-sm-12">
                <button class="btn btn-danger btn-sm login-button" type="submit" id="login-button">LOG IN113</button>
              </div>
