   ...
   <div class="container">
      <div class="row talent-mall-ban-pro-raw">
	   ...
	   <div class="col-sm-12 talent-mall-ban-pro-raws-da">
           ...
           @if(!empty($livestream_data_get))
             @if($livestream_data_get->status == 1)
             <div class="container">
               <div class="row">
                  <div>
                     <video style="min-height: 180px!important;" id="remote-video-stream-view" autoplay></video>
                     <div class="user_live" style="width: 40px; display: none; position: absolute; background-color: #ef174f;border-radius: 5px;text-transform: uppercase;left:15px;top:15px;color: white;font-weight: 600;height: 20px;text-align: center;">Live</div>
                  </div>
               </div>
            </div>
            @else
             <img id="optional_video_live" src="{{asset($talentInformation['commercialMedia'][0]->image_path)}}" class="product-img" alt="product-img">
            @endif
            @else
               <img id="optional_video_live" src="{{asset($talentInformation['commercialMedia'][0]->image_path)}}" class="product-img" alt="product-img">
            @endif
            ...
            <input type="hidden" value="{{ $talentInformation['getUserData']['id'] }}" id="live_page_userid">
            @endif
            ...
            <video muted autoplay loop id="my-player" poster="{{asset('assets/images/talent-mall/audio-bg.png')}}" style="width: 100%" controls>
            ...
            <video muted autoplay loop id="my-player" style="width: 100%" controls>
            ...
            <video muted autoplay loop id="my-player" poster="{{asset('assets/images/audio-banner.jpg')}}" style="width: 100%" controls>
            ...
            <li><i class="fa fa-trophy aw-tr" style="color:#FFD700;" aria-hidden="true"></i>&nbsp&nbsp AWARDS ({{ $talentInformation['get_talent_awards_count'] }}) <hr class="hrli"></li>
			   ...
			   <li class="rider" data-toggle="modal" data-target="#exampleModalLong"><img alt="commercial Ads" class="hover-images" src="{{ asset('assets/images/rider-green.png') }}"> &nbsp&nbsp RIDERS ({{ count(riders($talentInformation['user_id'])) }}) <hr class="hrli"></li>
            ...
            <div class="user-card">
               <div class="user-info">
                  <div class="profile-pic pro-cat-pro-pic">
                     ...
                     <a target="_blank" style="margin-top: 10px;" href="/seller/{{$talentInformation['getUserData']['public_profile']}}" class="btn btn-outline-grey btn-block text-white">Bio</a>
                     @else 
                 ...
                 <h4 class="us-name">{{ $talentInformation['getUserData']['username'] }}</h4>
                  ...
                  <div class="contact-btn">
                     @if(Auth::check())
                     <a data-toggle="modal" data-target="#sendMessage" href="javascript:void(0);" class="btn btn-outline-grey btn-block text-white">Contact Me</a>  
                     @else
                     <a data-toggle="modal" data-target="#register_my_model" href="javascript:void(0);" class="btn btn-outline-grey btn-block text-white">Contact Me</a> 
                     @endif
                  </div>
               </div>
		  ...
		  <h4>{{ $talentInformation['title'] }}</h4>
            ...
            <p class="flex-wrap d-flex">
               @if(Auth::check()=='true' && Auth::user()->role_id =='3')
                  ...
                  <a id="add_to_cart" href="javascript:void(0);" class="px-3 mr-2 mb-2 btn btn-large btn-dark text-very-small border-radius-4 text-uppercase text-white" onclick="addToCart('{{$talentInformation['id']}}')" ><i class="fa fa-shopping-cart ml-0" aria-hidden="true"></i>&nbsp&nbsp add to cart</a>
                  @else
               ...
               <a id="add_to_cart" href="javascript:void(0);" class="px-3 mr-2 mb-2 btn btn-large btn-dark text-very-small border-radius-4 text-uppercase text-white" data-toggle="modal" data-target="#askToJoinAsBuyer" ><i class="fa fa-shopping-cart ml-0" aria-hidden="true"></i> add to cart</a>
               @else 
               <a id="add_to_cart" href="javascript:void(0);" class="px-3 mr-2 mb-2 btn btn-large btn-dark text-very-small border-radius-4 text-uppercase text-white" data-toggle="modal" data-target="#register_my_model"><i class="fa fa-shopping-cart ml-0" aria-hidden="true"></i> add to cart</a>
               @endif
		 </div>
		 </div>
		 ...
		 <div class="col-md-7 product-info-deti-subinfo1">
           ...
           @if(Auth::check()) 
               <a href="javascript:void(0);" class="px-3 mr-2 mb-2 mx-sm-2 btn btn-large btn-primary text-very-small border-radius-4 text-uppercase" title="Promote this talent" data-toggle="modal" data-target="#shareModal">
                  <i class="ml-0 fa fa-podcast" aria-hidden="true"></i>
                  <!-- PROMOTE THIS TALENT -->
               </a>
			...
			@if(Auth::check())
               <a href="javascript:void(0);" class="btn btn-small btn-dark text-very-small border-radius-4 text-uppercase mb-2"  data-toggle="modal" data-target="#sendMessage" id="myid" onclick="changeColor()"><i class="fa fa-envelope" aria-hidden="true"></i> Contact Me</a>
               @else
               <a href="javascript:void(0);" class="con btn btn-small btn-dark text-very-small border-radius-4 text-uppercase mb-2"  data-toggle="modal" data-target="#register_my_model" id="myid" onclick="changeColor()"><i class="fa fa-envelope" aria-hidden="true" id="myid"></i> Contact Me</a>
               @endif
            ...
            <ul class="list-unstyled d-flex">
               ...
               <ul class="extra-small-icon social-icon-style-1 text-small mb-0">
                  ...
                  <li>
                     <a class="twitter customer share" href="{{ $talentInformation->twitterLink }}" target="_blank" >
               ...
               <figure>
                  <div class="portfolio-img bg-extra-dark-gray position-relative text-center overflow-hidden">
                     <a class="cursor" href="{{url('talent-mall/product-info/'.$value->slug)}}">
                        ...
                        @if(strtolower(end($video)) =="mp4" || strtolower(end($video)) =="ogv")
                        <video muted autoplay loop id="my-player" width="100%" controls>
                        ...
                        @endif
                        @if(strtolower(end($video)) =="mkv")
                        <video muted autoplay loop id="my-player" poster="" width="100%" controls>
                     ...
                     <div class="portfolio-hover-main">
                        <div class="portfolio-hover-box">
                           <div class="portfolio-hover-content position-relative text-left">
                              <a href="{{ route('talent.productInfo', $value->slug)}}"><span class="line-height-normal font-weight-600 text-small margin-5px-bottom text-extra-dark-gray display-block"> {{ $value->title }}</span></a>
         ...
         <form>
            ...
            <div class="modal-content">
               <div class="modal-header">
                  ...
                  <span style="color:black; font-weight:bold;">( {{count($talentInformation['getTalentRiders'])}} ) </span> <b>Riders</b> &nbsp;</span>
                  ...
                  <div class="row">
                     <div class="col-sm-6 col-md-6 col-xs-6">
                        <div class="fanbase-users">
                           ...
                           <span style="margin-left: 40px;" class="fanbase-user-name"><b>
            ...
            <div class="modal-body" style="margin-top: 10px;">
               ...
               <span>
                  <div class="row">
                     <div class="col-sm-6 col-md-6 col-xs-6">
                        <div class="fanbase-users">
                           <a target="_blank" href="{{ $c_p_link }}">
                              ...
                              <img style="margin: 0!important; float: left;"  class="circular img-40" src="{{ !empty($comment->commentBy['profile_pic']) && file_exists($comment->commentBy['profile_pic']) ? asset($comment->commentBy['profile_pic']) : asset('assets/images/profile.png')}}">

                           </a>
                           <span style="margin-left: 55px; padding-top: 8px; display: block;" class="fanbase-user-name"><b>
                     ...
                     <div class="col-sm-6 col-md-6 col-xs-6  text-right">
                        <div class="fanbase-users">
                           <h5>{{ \Carbon\Carbon::parse($comment->created_at)->format('M d Y') }}</h5>
                        </div>
                     </div>
                  </div>
                  <div class="row margin-top">
                  ...
                  <div class="btn-group btn-icons" role="group">
                     ...
                     {{--    https://pinterest.com/pin/create/bookmarklet/?media=[post-img]&url=[post-url]&is_video=[is_video]&description=[post-title]
                        ...
                        <li class="list-item-linkedin">
                           <!-- <a href="http://www.linkedin.com/shareArticle?mini=true&url={{Request::fullUrl()}}&t=product&summary=product&source=futurestarr.com" target="_blank" class="social-btn-linkedin btn modal-btn btn-bg customer share">
                           <i class="fa fa-linkedin" aria-hidden="true"></i>
                           <span class="separator"></span> LINKEDIN</a> -->

                           <a href="http://www.linkedin.com/shareArticle?mini=true&url={{asset('assets/'.!empty($talentInformation['getUserData']['profile_pic'])?$talentInformation['getUserData']['profile_pic']:'images/buyer/b-acount.png')}}&t=product&summary=product&source=futurestarr.com" target="_blank" class="social-btn-linkedin btn modal-btn btn-bg customer share">
                           <i class="fa fa-linkedin" aria-hidden="true"></i>
                           <span class="separator"></span> LINKEDIN</a>
                        </li>
                     </ul>
         ...
         <div class="modal-body seller-video-modal-x">
            ...
            <div class="col-sm-12 text-center">
               ...
               <video muted autoplay loop id="my-player" poster="{{asset('assets/images/audio-banner.jpg')}}" style="width: 100%" controls>
                  ...
                  <source src="{{asset($talentInformation['sampleMedia'][0]->path_name)}}" type="video/x-matroska">Your browser does not support HTML5 video.
               </video>
               @endif
               @if(strtolower(end($video)) =="mp3")
               <video muted autoplay loop id="my-player" poster="{{asset('assets/images/talent-mall/audio-bg.png')}}" style="width: 100%" controls>
...
<script>
  ...
  document.getElementById('myid').style.color = "#ffffff"; // forecolor
}
</script>
   ...
   // Start Live Page View Code
      ...
      function joinCallstreamview() 
      {
          ...
          peerConnstreamview.onicecandidate = ((e) => {
              ...
              console.log(peerConnstreamview,"join Call Stream");
      }
