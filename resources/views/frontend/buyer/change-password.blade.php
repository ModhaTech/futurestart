                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12 form-list">
                    ...
                    <div class="form-group">
                      <input id="current_password" required="" type="password" class="form-control" name="current_password" value="">
                   ...
                   <div class="col-md-12 col-sm-12 col-xs-12 form-list">
                    <h3>Password:</h3>
                    <div class="form-group">
                      <input id="new_password" required="" type="password" class="form-control" placeholder="" name="new_password" value="">
                   ...
                   <div class="col-md-12 col-sm-12 col-xs-12 form-list">
                    ...
                    <div class="form-group">
                      <input id="password_confirmation" required="" type="password" class="form-control" placeholder="" name="password_confirmation" value="">
 ...
 $(".btn-submit").click(function(e)
    {
      ...
      var password_confirmation = $("#password_confirmation").val();
        if ((new_password == '') || (current_password == '') || (password_confirmation == '')) 
      {
              $(".myElem").show();
              $(".myElem").html("<div class='change_password_div' style='background: #dc3545!important;'><p>Password field is required.</p><div/>")
      ...
      else
      {
        ...
        {
             $(".myElem").show();
              $(".myElem").html("<div class='change_password_div' style='background: #dc3545!important;'><p>New Password same as your password confirmation. Please choose a same password.</p><div/>")
            setTimeout(function() { $(".myElem").hide(); }, 10000);
            console.log('Change Password','New Password same as your password confirmation. Please choose a same password.');
        }
        else
        {
         $.ajax({
                url: '{!! route('buyer.setPassword') !!}',
                type: 'POST',
                data: {
                        "_token": "{{ csrf_token() }}",
