...
<head>
    ...
    <style>
        ...
        .slider-typography  .slider-text-middle {
            max-width: 100%;
            margin: 0 auto;
        }
        ...
        .feature-box-5 {
            box-shadow: 0px 4px 8px rgba(45, 32, 32, 0.1);
            padding: 20px;
        ...
        <section class="py-5" style="background-color: #fffcf3; margin-bottom: 100px;">
            <div class="container">
                <div class="text-center mb-5">
                    ...
                    <h2 class="text-uppercase font-weight-bold">Why Choose fthfhthFuture Starr</h2>
