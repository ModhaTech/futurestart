...
<style type="text/css">
    ...
    #videoMessage { position: absolute !important; top: 110px; left: 80px;
        display: flex;
...
<div class="home">
    <section class="s1 p-0 parallax mobile-height wow fadeIn hpfs01" data-stellar-background-ratio="0.5">
        <video id="video1" muted loop autoplay>
          <source src="/assets/images/homepage-5-slider-img-1.mp4" type="video/mp4">
            ...
            <div class="row">
                    ...
                    <div class="p-4 h-100 bg-white box-shadow-m text-center">
                        <div>
                            <video muted loop autoplay>
                              <source src="assets/home_gifs/post296_1.mp4" type="video/mp4">
                              Your browser does not support the video tag.
                            </video>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 mb-4 mb-lg-0">
                    <div class="p-4 h-100 bg-white box-shadow-m text-center">
                        <div>
                            <video muted loop autoplay>
                              <source src="assets/home_gifs/post289_1.mp4" type="video/mp4">
                              Your browser does not support the video tag.
                            </video>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 mb-4 mb-lg-0">
                    <div class="p-4 h-100 bg-white box-shadow-m text-center">
                        <div>
                            <video muted loop autoplay>
                              <source src="assets/home_gifs/post318_1.mp4" type="video/mp4">
                              Your browser does not support the video tag.
                            </video>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 mb-sm-4 mb-lg-0">
                    <div class="p-4 h-100 bg-white box-shadow-m text-center">
                        <div>
                            <video muted loop autoplay>
                              <source src="assets/home_gifs/post338_1.mp4" type="video/mp4">
                              Your browser does not support the video tag.
                            </video>
                        </div>
    ...
    <section class="no-padding wow fadeIn bg-extra-dark-gray hpfs02" id="services">
        <div class="container-fluid no-padding">
            <div class="row equalize sm-equalize-auto no-margin n-dark-sec">
                <div onclick="window.open('https://play.google.com/store/apps/details?id=com.futurestar&hl=en&gl=US', '_blank')" class="col-md-6 position-relative sm-height-auto xs-height-350px wow slideInLeft hpfs03 image-blur" data--duration="900ms">
                    <video style="border: none !important;" muted loop autoplay>
                      <source src="/assets/images/post342.mp4" type="video/mp4">
                      Your browser does not support the video tag.
                    </video>
                </div>
                    ...
                    <div class="h-100 blog-post blog-post-style1 xs-text-center bg-white">
                        <div class="blog-post-images overflow-hidden">
                            <a href="{{ route('search.index',$category->slug) }}">
                                <img  alt="{{$category->category_alt}}" src="{{asset('assets/'.$category->catagory_image_path)}}" loading="lazy"></a>
                        </div>
                    ...
                    <div class="blog-post bg-light-gray inner-match-height">
                        <div class="blog-post-images overflow-hidden position-relative">
                            <a href="{{ route('blog.detailed',[$blog->getBlogCatagories['slug'], $blog->slug]) }}" href="javascript:void(0);">
                              <img src="{{asset( !empty($blog->blog_img) ? $blog->blog_img:'assets/images/default-ad-banner.png')}}" alt="Blog Media" data-mm="{{ asset($blog->blog_img) }}" loading="lazy">
